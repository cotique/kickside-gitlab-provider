...
The Kickside development handbook is bundled under
[`kickside-development/`](kickside-development/developer-handbook.md), including
...
[`../AGENTS.md`](../AGENTS.md). When the Wiki and executable gitlab module disagree,
